...
REAL(idp)                   :: Poseidon_Time

CALL TimerStop( Timer_Total )

Poseidon_Time = Timer_Total - Timer_Initialize_Test_Problem
...
WRITE(*,'(7X,A,5X,ES12.6E2,A)') &
  'Initialize Test Problem          :', Timer_Initialize_Test_Problem, ' s'
WRITE(*,*)

WRITE(*,'(7X,A,5X,ES12.6E2,A)') &
  'Poseidon Total Run Time          :', Poseidon_Time, ' s'
WRITE(*,*)
WRITE(*,'(7X,A,5X,ES12.6E2,A)') &
