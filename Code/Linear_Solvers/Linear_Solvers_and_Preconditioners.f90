...
USE Global_Variables_And_Parameters, &
                ONLY :  NUM_R_NODES, L_LIMIT, DEGREE, NUM_R_ELEMENTS,   &
                        Source_Vector,                                  &
                        STF_MAT,                                        &
                        STF_ELEM_VAL,                                   &
                        STF_COL_PTR,                                    &
...
REAL(KIND = idp), DIMENSION(0:NUM_R_NODES-1,0:NUM_R_NODES-1), INTENT(IN)        :: WORK_MAT


REAL(KIND = idp), DIMENSION(0:NUM_R_NODES-1, 0:NUM_R_NODES-1)       :: A
REAL(KIND = idp), DIMENSION(0:NUM_R_NODES-1)                        :: b, Z
REAL(KIND = idp), DIMENSION(0:NUM_R_NODES-1)                        :: X

INTEGER                                             :: i, j, k, ierr, MAX_ITER

REAL(KIND = idp)                                    :: alpha, omega

REAL(KIND = idp), DIMENSION(0:NUM_R_NODES-1)            ::  P, Q, R
...
REAL(KIND = idp), DIMENSION(0:N-1)                          :: X, P, Q, R, Z
...
tol = eps*eps
k = 1
DO WHILE ((MAXVAL(R) .GE. eps) .AND. ( abs(rho) .GE. tol)  .AND. (k .LE. MAX_ITER))!
...
REAL(KIND = idp), DIMENSION(0:NUM_R_NODES -1), INTENT(INOUT)                        :: B
REAL(KIND = idp), DIMENSION(0:NUM_R_NODES -1, 0:NUM_R_NODES-1), INTENT(INOUT)       :: A
...
REAL(KIND = idp), DIMENSION(0:NUM_R_NODES -1)                                  :: TMP_VEC
REAL(KIND = idp), DIMENSION(0:NUM_R_NODES-1, 0:NUM_R_NODES-1)                  :: CONDITIONER, TMP_MAT
...
CALL DGEMM('N','N',NUM_R_NODES, NUM_R_NODES, NUM_R_NODES, 1.0_idp, CONDITIONER, NUM_R_NODES, &
                                                A, NUM_R_NODES, 0.0_idp,TMP_MAT, NUM_R_NODES )

CALL DGEMV('N', NUM_R_NODES, NUM_R_NODES, 1.0_idp, CONDITIONER, NUM_R_NODES, b, 1, 0.0_idp, TMP_VEC, 1)
...
REAL(KIND = idp), DIMENSION(0:N-1), INTENT(INOUT)           :: WORK_VEC
...
REAL(KIND = idp), DIMENSION(0:NNZ - 1), INTENT(IN)          :: ELEM_VAL
REAL(KIND = idp), DIMENSION(0:N-1), INTENT(IN)              :: WORK_VEC
REAL(KIND = idp), DIMENSION(0:N-1), INTENT(INOUT)           :: Z
...
REAL(KIND = idp), DIMENSION(0:N - 1, 0:N - 1), INTENT(IN)       :: A
...
REAL(KIND = idp), INTENT(IN)                                                        :: omega
REAL(KIND = idp), DIMENSION(0:NUM_R_NODES -1), INTENT(IN)                           :: B
REAL(KIND = idp), DIMENSION(0:NUM_R_NODES -1, 0:NUM_R_NODES-1), INTENT(IN)          :: A

REAL(KIND = idp), DIMENSION(0:NUM_R_NODES -1), INTENT(INOUT)                        :: Z
